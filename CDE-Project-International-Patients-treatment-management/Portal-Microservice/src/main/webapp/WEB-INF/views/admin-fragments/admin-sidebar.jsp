...
<div class="side-navbar">
	<ul class="list-unstyled" id="pageSubmenu">
		...
		<li><a href="/portal/specialistsByExpertsise">View Specialists Based On Expertise</a></li>
		<li><a href="/portal/addSpecialist">Add A New Specialist</a></li>
		...
		<li><a href="/portal/updatePackage">Update a Treatment Package</a></li>
		...
		<li><a href="/portal/deleteSpecialist">Delete A Specialist</a></li>
