...
class IPTreatmentOfferingServiceTest {
	...
	@Mock
	PackageDetailRepository packageRepository;
	...
	public void testValidfindIPTreatmentPackageByName() throws IPTreatmentPackageNotFoundException {
		...
		assertTrue(ipOfferingService.findIPTreatmentPackageByName(AilmentCategory.ORTHOPAIDICS, "Package 1")
				.getPackageDetail().equals(package1));
	}
	 ...
	 */
	@Test
	@DisplayName("Test addSpecialist() of SpecialistDetailService")
	public void testAddSpecialist() {

		SpecialistDetail specialist3 = new SpecialistDetail(202, "Dr Mocki", AilmentCategory.UROLOGY, 10, 9223344556L);
		when(specialistRepository.save(specialist3)).thenReturn(specialist3);
		assertThat(ipOfferingService.addSpecialist(specialist3).equals(specialist3));
	}

	@Test
	@DisplayName("Test findByAreaOfExpertise() of SpecialistDetailService")
	public void testFindByAreaOfExpertise() {

		SpecialistDetail specialist3 = new SpecialistDetail(203, "Dr Mocki", AilmentCategory.UROLOGY, 10, 9223344556L);
		when(specialistRepository.findByAreaOfExpertise(Mockito.any())).thenReturn(List.of(specialist3));
		assertThat(ipOfferingService.findByAreaOfExpertise(AilmentCategory.UROLOGY).equals(specialist3));
	}

	@Test
	@DisplayName("Test deleteSpecialist() of SpecialistDetailService")
	public void testDeleteSpecialist() {
		Mockito.when(ipOfferingService.delete(1)).thenReturn(true);
	}

	@Test
	@DisplayName("Test updateTreatmentPackage() of SpecialistDetailService")
	public void testUpdateTreatmentPackage() {

		assertThat(ipOfferingService.updateTreatmentPackage(102,
				new PackageDetail(0, "UROLOGY", List.of("OPT1", "OPT1"), 90000, 12)));
	}
}
