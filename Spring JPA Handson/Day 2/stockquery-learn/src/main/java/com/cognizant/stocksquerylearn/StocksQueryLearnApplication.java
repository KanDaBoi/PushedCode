package com.cognizant.stocksquerylearn;
...
import com.cognizant.stocksquerylearn.model.Stock;
import com.cognizant.stocksquerylearn.service.StockService;


@SpringBootApplication
public class StocksQueryLearnApplication {
	
	private static StockService stockService;
	private static final Logger LOGGER = LoggerFactory.getLogger(StocksQueryLearnApplication.class);
	public static void main(String[] args) {
		LOGGER.info("Inside main");
		ApplicationContext ctx = SpringApplication.run(StocksQueryLearnApplication.class, args);
